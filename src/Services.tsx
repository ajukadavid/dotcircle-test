...
function Services() {
  ...
  return (
    <div className="bg-black px-5 md:px-10 mt-10 md:mt-20">
      ...
      <div className="grid font-basic grid-cols-1 md:grid-cols-2 px-2 md:px-20 gap-4 mt-4 md:mt-8">
        {cardData.map((card, index) => (
          ...
          >
            ...
            <div
              className={`hover:bg-right-bottom flex transition-colors duration-4000 cursor-pointer text-white flex-col p-4 gap-4 md:gap-8 ${
                hoveredIndex === index
                  ? "bg-gradient-to-r from-[#202020] via-[#062625] to-[#126b64] transition-colors duration-4000 cursor-pointer text-white flex-col p-4 gap-4 md:gap-8"
                  : "bg-[#202020] transition-colors duration-4000 cursor-pointer text-white flex-col p-4 gap-4 md:gap-8"
              }`}
            >
              <span className="text-sm">{card.title}</span>
              <span className="text-xl md:text-2xl font-bold">{card.subtitle}</span>
